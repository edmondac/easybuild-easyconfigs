...
class EasyConfigTest(TestCase):
    ...
    def check_dep_vars(self, dep, dep_vars):
        ...
        old_dep_versions = {
            ...
            # Deepbinner and n2v require TensorFlow 1.15.0. GPflow and tensorflow-probability 0.10.1 require TensorFlow 2.2.0
            'TensorFlow': (r'[12]\.[12]', ['Keras-2.3.1-', 'Deepbinner-c261ae9-', 'BEAR-Python-Sciences-2019b-', 'n2v-0.1.11-', 'AugmentedAutoencoder-0c8100f-', 'GPflow-2.1.1-', 'tensorflow-probability-0.10.1-']),
